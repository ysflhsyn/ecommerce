...
export default function (props) {
    ...
    return (
        ...
        <ReactTable
            ...
            columns={[
                {
                    Header: <FormattedMessage id="product.articules.table.articule_number" defaultMessage="Articule Number"/>,
                    accessor: "articuleNumber"
                },
                {
                    Header: <FormattedMessage id="product.articules.table.category" defaultMessage="Category"/>,
                    accessor: "categoryDescription"

                },
                {
                    Header: <FormattedMessage id="product.articules.table.partner_item_name" defaultMessage="Partner Item Name"/>,
                    accessor: "partnersItemName"
                },
                {
                    Header: <FormattedMessage id="product.articules.table.shop" defaultMessage="Shop"/>,
